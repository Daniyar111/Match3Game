...
import 'package:match3_game/src/models/avalanche_test.dart';
...
import 'package:match3_game/src/models/tile_animation.dart';
import 'package:match3_game/src/models/tile_animation_type.dart';
...
class AnimationsResolver {
  ...
  AnimationsResolver({this.gameBloc, this.level}){
      ...
      if (combo.type != ComboType.none){
        ...
        if (combo.type == ComboType.three){
          ...
          if (combo.commonTile == null){
            print('Daniyar, we have a problem');
