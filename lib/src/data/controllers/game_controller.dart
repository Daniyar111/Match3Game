...
import 'package:match3_game/src/models/chain.dart';
import 'package:match3_game/src/models/chain_type.dart';
...
import 'package:match3_game/src/models/swap.dart';
import 'package:match3_game/src/models/swap_move.dart';
...
class GameController {
  ...
  Map<TileType, List<SwapMove>> _explosions = {
    TileType.flare: <SwapMove>[
                      ...
                      SwapMove(row: -1, col: 0),
                      SwapMove(row: 1, col: 0),
                      SwapMove(row: 0, col: 0),
                    ],
    TileType.bomb: <SwapMove>[
                    SwapMove(row: 0, col: -2),
                    SwapMove(row: 0, col: -1),
                    SwapMove(row: 0, col: 1),
                    SwapMove(row: 0, col: 2),
                    SwapMove(row: -1, col: 0),
                    SwapMove(row: -1, col: -1),
                    SwapMove(row: -1, col: 1),
                    SwapMove(row: 1, col: -1),
                    SwapMove(row: 1, col: 0),
                    SwapMove(row: 1, col: 1),
                    SwapMove(row: -2, col: 0),
                    SwapMove(row: 2, col: 0),
                    SwapMove(row: 0, col: 0),
                  ],
    TileType.wrapped: <SwapMove>[
                        SwapMove(row: 0, col: -3),
                        SwapMove(row: 0, col: -2),
                        SwapMove(row: 0, col: -1),
                        SwapMove(row: 0, col: 1),
                        SwapMove(row: 0, col: 2),
                        SwapMove(row: 0, col: 3),
                        SwapMove(row: -1, col: -2),
                        SwapMove(row: -1, col: -1),
                        SwapMove(row: -1, col: 0),
                        SwapMove(row: -1, col: 1),
                        SwapMove(row: -1, col: 2),
                        ...
                        SwapMove(row: 1, col: 1),
                        SwapMove(row: 1, col: 2),
                        SwapMove(row: -2, col: -1),
                        SwapMove(row: -2, col: 0),
                        SwapMove(row: -2, col: 1),
                        SwapMove(row: 2, col: -1),
                        SwapMove(row: 2, col: 0),
                        SwapMove(row: 2, col: 1),
                        SwapMove(row: -3, col: 0),
                        SwapMove(row: 3, col: 0),
                        SwapMove(row: 0, col: 0),
                      ],
  };
        ...
        for (int col = 0; col < level.numberOfCols; col++) {
          ...
          switch (level.grid[row][col]) {
            ...
            case '2': // Regular cell but frozen
              ...
              } while ((col > 1 && _grid[row][col - 1].type == type && _grid[row][col - 2].type == type) ||
                  (row > 1 && _grid[row - 1][col].type == type && _grid[row - 2][col].type == type));
...
//TODO: check if the move is allowed (barriers)
            ...
            if (destRow > -1 && destRow < totalRows && destCol > -1 && destCol < totalCols) {
